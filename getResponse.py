...
def getConnectedRealmIndex(region = region, namespace = dynamicNamespace, locale = locale):
    return requests.get('https://us.api.blizzard.com/data/wow/connected-realm/index', params={'region':region, 'namespace': namespace, 'locale': locale, 'access_token':accessToken})

def getRealm(connectedRealmId, region = region, namespace = dynamicNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/connected-realm/{connectedRealmId}', params={'region':region, 'namespace': namespace, 'locale': locale, 'access_token':accessToken})

def getAuctions(connectedRealmId, region = region, namespace = dynamicNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/connected-realm/{connectedRealmId}/auctions', params={'region':region, 'namespace':namespace, 'locale':locale, 'access_token':accessToken})

def getProfessionIndex(region = region, namespace = staticNamespace, locale = locale):
    return requests.get('https://us.api.blizzard.com/data/wow/profession/index', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})
...
def getProfessionTeirs(professionId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/profession/{professionId}', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})

def getProfessionIcon(professionId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/media/profession/{professionId}', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})
...
def getProfessionTeirDetails(professionId, skillTierId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/profession/{professionId}/skill-tier/{skillTierId}', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})

def getRecipeDetails(recipeId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/recipe/{recipeId}', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})

def getRecipeIcon(recipeId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/media/recipe/{recipeId}', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})

#consumable, ...
def getItemClasses(region = region, namespace = staticNamespace, locale = locale):
    return requests.get('https://us.api.blizzard.com/data/wow/item-class/index', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})

#flasks, vantus runes, ...
def getItemSubclasses(itemClassId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/item-class/{itemClassId}', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})

def getItemSetIndex(region = region, namespace = staticNamespace, locale = locale):
    return requests.get('https://us.api.blizzard.com/data/wow/item-set/index?', params={'namespace':namespace, 'region':region, 'locale':locale,'access_token':accessToken})
...
def getItemIcon(itemId, region = region, namespace = staticNamespace, locale = locale):
    return requests.get(f'https://us.api.blizzard.com/data/wow/media/item/{itemId}', params={'namespace':namespace, 'region':region, 'locale':locale,'access_token':accessToken})

def getWowToken(region = region, namespace = staticNamespace, locale = locale):
    return requests.get('https://us.api.blizzard.com/data/wow/token/index', params={'namespace':namespace, 'region':region, 'locale':locale, 'access_token':accessToken})
